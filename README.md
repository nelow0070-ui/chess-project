...
5. 수 카드의 `경기` 버튼으로 해당 수가 나온 경기 목록을 열고, 단일 경기 분석 확인
...
1.2.0부터 보드의 수 목록은 불렛, 블리츠, 래피드, 일일 경기 카테고리로 필터링할 수 있고,
단일 경기 분석은 깊이 14 이상으로 자동 저장됩니다. 탁월수 표시는 Chess.com의 Brilliant
정의에 맞춰 좋은 희생이면서 최선 또는 거의 최선인 수에만 보수적으로 적용합니다.
...
1.2.0의 기본 분석 설정은 깊이 14와 병렬 작업자 6개입니다. 6게임 277수를
...
빌드 결과는 `release\checkss-Setup-1.2.0.exe`입니다. 설치 사용자는 Python
